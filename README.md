...
La Gemini API key classica non deve essere inserita direttamente nel codice frontend.

Nel progetto il chatbot è stato adattato per usare Firebase AI Logic, così il sito non contiene più una chiamata diretta a Gemini con una chiave Gemini scritta nel codice.

La configurazione Firebase presente nei file frontend è normale per un progetto Firebase web.

## Come avviare il progetto

Il progetto può essere pubblicato come sito statico.

File principali da caricare:
...
Se si usa GitHub Pages, caricare i file nella repository e abilitare Pages dalle impostazioni della repository.

## Stato del progetto

Il sito include già le principali funzioni per:

- pubblicare appunti;
- consultarli;
- interagire con like, commenti e preferiti;
- ricevere notifiche;
- usare un chatbot AI;
